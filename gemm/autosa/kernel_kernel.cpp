...
/* Module Definition */
void C_drain_IO_L3_out_serialize(C_t8 *C, hls::stream<C_t2> &fifo_C_drain_local_in){
#pragma HLS INLINE OFF
  /* Variable Declaration */
  /* Variable Declaration */
