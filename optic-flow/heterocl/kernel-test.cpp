      ...
      #pragma HLS pipeline
        ...
        if ((((2 <= y) && (y < 434)) && (2 <= x)) && (x < 1022)) {
          ...
          if (denom != 0) {
            ...
            flow_calc_output[((x + (y * 1024)) * 2)] = res;
          }
        }
      }
    }
...
extern "C" {
    ...
    #pragma HLS data_pack variable=output_image
    ...
    #pragma HLS dataflow
      ...
      ap_uint<8> frame3[446464];
      #pragma HLS stream variable=frame3 depth=1024
      ...
      for (int r=0; r < 436; r++) {
         ...
         #pragma HLS pipeline II=1
             ap_int<64> buf = input_images[r * 436 + c];
             frame1[r * 436 + c]   = ap_uint<8>(buf(7,   0)>>8);
             frame2[r * 436 + c]   = ap_uint<8>(buf(15,  8)>>8);
             frame3[r * 436 + c]   = ap_uint<8>(buf(23, 16)>>8);
             frame3_a[r * 436 + c] = ap_uint<8>(buf(23, 16)>>8);
             frame4[r * 436 + c]   = ap_uint<8>(buf(31, 24)>>8);
             frame5[r * 436 + c]   = ap_uint<8>(buf(39, 32)>>8);
         }
      }
      ...
      calc_z_gradient(frame1, frame2, frame3, frame4, frame5, grad_z);
