    ...
    #pragma HLS dataflow
      ...
      for (int r=0; r < 436; r++) {
         ...
         #pragma HLS pipeline II=1
             ...
             frame1[r * 436 + c]   = ((buf(7,   0)) >> 8);
             frame2[r * 436 + c]   = ((buf(15,  8)) >> 8);
             frame3_a[r * 436 + c] = ((buf(23, 16)) >> 8);
             frame3_b[r * 436 + c] = ((buf(31, 24)));
             frame4[r * 436 + c]   = ((buf(39, 32)) >> 8);
             frame5[r * 436 + c]   = ((buf(47, 40)) >> 8);
         }
      }
